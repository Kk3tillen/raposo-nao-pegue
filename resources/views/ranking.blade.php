...
@section('content')
    @if (!(count($games) === 0))
        <div class="card mt-4 m-auto p-3 background-black text-black" style="width: 18rem;">
            <p class="text-center text-black align-middle">
                1º <span class="material-symbols-rounded align-middle text-warning fs-2">kid_star</span>
            </p>
            <img src="{{ asset('images/dora.jpg') }}" alt="Player image" class="w-50 mt-1 m-auto" style="border-radius: 50%">
    ...
    <table class="table table-dark table-bordered w-50 mt-4 m-auto table-striped text-center">
        <thead>
            <tr>
                <th scope="col" class="bg-success text-ligth">POSIÇÃO</th>
                <th scope="col" class="bg-success text-ligth">NOME</th>
                <th scope="col" class="bg-success text-ligth">ACERTOS</th>
                <th scope="col" class="bg-success text-ligth">ERROS</th>
                <th scope="col" class="bg-success text-ligth">DATA/HORA</th>
            </tr>
        </thead>
        <tbody>
            @if (count($games) === 0)
