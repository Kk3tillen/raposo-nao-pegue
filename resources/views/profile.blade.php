                    ...
                    <div class="card rounded-2 background-black">
                        <div class="card-body p-4">
                            <div class="text-center">
                                <img src="{{ asset('images/dora.jpg') }}" alt="User authenticate image" class="w-25 h-25" style="border-radius: 50%">
                                <h5 class="mt-2 text-black text-black ">{{ Auth::user()->name }}</h5>
                                <p class="text-black fs-4 mt-4 align-middle">
                                    @if ($position)
                                        {{ $position }}º
                                    @else
                                        Ainda não rankeado
